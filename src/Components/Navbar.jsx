    ...
    <div className='navbar' >
        ...
        <ul ref={menuRef} className='nav-menu'>
          <img src={menu_close} onClick={closeMenu} alt="" className="nav-mob-close" />
            ...
            <li><AnchorLink  className = "anchor-link" offset={50} href ="#services"><p  onClick={()=>setMenu("services")} >Service</p></AnchorLink>{menu === "services" ? <img src={nav_underline} alt="" /> : <></>} </li>
        ...
        <div className='nav-connect'><AnchorLink className = "anchor-link" offset={50} href ="#contact"><p  onClick={()=>setMenu("contact")} >Conatact with me</p></AnchorLink></div>
    </div>
  )
}
